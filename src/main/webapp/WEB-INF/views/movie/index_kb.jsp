...
<div class="header">
  ...
  <div class="menu">
    <ul>
      ...
      <li id="a6"><a href="<%=basePath%>/movie/index?url=index_xj">喜剧</a></li>      <li id="a7"><a href="<%=basePath%>/movie/index?url=index_jq">剧情</a></li>
...
<div class="contenter">
  <div class="left">
    ...
    <div class="left_4 top10px" style="height:auto;">
      <h2><a href="#">恐怖</a><span> ---- 畅享影业帮助您快速购票、享受便捷网络购票体验 </span></h2>
      <div class="inner">
        <c:forEach items="${kb}" var="movie">
        <dl class="anli_list">
