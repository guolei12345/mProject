    ...
    <div id="YFocus">
        <div id="YImage">
            <p id="YPhotos">
                ...
                <a href="/movie/videoInfo?movieid=${movie.moveid}"><img src="/movie/getPic?path=${movie.pic.picurl}"
                                                                        alt="22"/>
                    </c:forEach>
            </p>
        </div>
            ...
            <div class="left_1_con">
                <div class="left_1_l">
                    <div class="scrolldoorFrame">
                        <ul class="scrollUl">
                            <c:forEach items="${syzklbt}" var="movie" varStatus="idx">
                                <li class="sd0${idx.index+1}" id="m0${idx.index+1}"><a href="#">
                                    <dl class="hd_list">
                                        <dt><img src="/movie/getPic?path=${movie.pic.picurl}" width="81" height="35"/>
                                        </dt>
                        ...
                        <div class="cont">
                            <c:forEach items="${syzklbt}" var="movie" varStatus="idx">
                                <div id="c0${idx.index+1}"><a href="/movie/videoInfo?movieid=${movie.moveid}"><img
                                        src="/movie/getPic?path=${movie.pic.picurl}" width="449" height="193"/></a>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
                ...
                <div class="left_1_r">
                    <h3>热映大片</h3>
                    <dl>
                        <dt><a href="/movie/videoInfo?movieid=${syzklbt[0].moveid}"><img
                                src="/movie/getPic?path=${syzklbt[0].pic.picurl}" width="80" height="65"/></a></dt>
                    ...
                    <ul>
                        <c:forEach items="${syzklbt}" var="movie" varStatus="idx">
                            <li>
                                <a href="/movie/videoInfo?movieid=${movie.moveid}"><span>${movie.movename}</span>${movie.language}
                                </a></li>
                        </c:forEach>
                    </ul>
                </div>
        ...
        <div class="left_4 top10px" style="height:auto;">
            ...
            <div class="inner">
                <c:forEach items="${aq}" var="movie">
                    <dl class="anli_list">
                        <dt><a href="/movie/videoInfo?movieid=${movie.moveid}"><img
                                src="/movie/getPic?path=${movie.pic.picurl}" width="150" height="100"/></a></dt>
                        <dd><a href="/movie/videoInfo?movieid=${movie.moveid}">${movie.movename}</a>
                            <p style="font-weight:bold;">${movie.date}</p>
                            <p>${movie.director}</p>
                            <p>导演：${movie.actor}</p>
                            <p><a href="/movie/videoInfo?movieid=${movie.moveid}"><input type="button" class="dgbg02"
                                                                                         value="特惠购票"/></a></p>
                        </dd>
                    </dl>
                </c:forEach>
                ...
                <dl>
                    ...
                    <dd style=" padding-top:10px;">
                        <input name="" type="button" class="dgbg" value="立即订购"
                               onclick="subOrderKs('/movie/videoInfo?movieid=','movieId')"/>
                    </dd>
                    <div class="clear"></div>
                </dl>
                <dl>
            ...
            <div class="inner02">
                <ul class="server_list">
                    <c:forEach items="${syxklbt}" var="movie">
                        <li>
                            <a href="/movie/videoInfo?movieid=${movie.moveid}"><span>${movie.language}</span>${movie.movename}
                            </a></li>
                    </c:forEach>
                </ul>
            </div>
                    ...
                    <c:forEach items="${movieList}" var="movie">
                        <tr>
                            <td height="135" align="center" width="140"><a
                                    href="/movie/videoInfo?movieid=${movie.moveid}"><img
                                    src="/movie/getPicById?picId=${movie.picid}" width="120" height="100"/></a></td>
