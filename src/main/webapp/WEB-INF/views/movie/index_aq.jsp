    ...
    <div id="YFocus">
        <div id="YImage">
            <p id="YPhotos">
                ...
                <a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><img src="<%=basePath%>/movie/getPic?path=${movie.pic.picurl}"
                                                                        alt="22"/>
                    </c:forEach>
            </p>
        </div>
...
<div class="contenter">
    <div class="left">
            ...
            <div class="left_1_con">
                <div class="left_1_l">
                    <div class="scrolldoorFrame">
                        <ul class="scrollUl">
                            <c:forEach items="${syzklbt}" var="movie" varStatus="idx">
                                <li class="sd0${idx.index+1}" id="m0${idx.index+1}"><a href="#">
                                    <dl class="hd_list">
                                        <dt><img src="<%=basePath%>/movie/getPic?path=${movie.pic.picurl}" width="81" height="35"/>
                                        </dt>
                        ...
                        <div class="cont">
                            <c:forEach items="${syzklbt}" var="movie" varStatus="idx">
                                <div id="c0${idx.index+1}"><a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><img
                                        src="<%=basePath%>/movie/getPic?path=${movie.pic.picurl}" width="449" height="193"/></a>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
                ...
                <div class="left_1_r">
                    <h3>热映大片</h3>
                    <dl>
                        <dt><a href="<%=basePath%>/movie/videoInfo?movieid=${syzklbt[0].moveid}"><img
                                src="<%=basePath%>/movie/getPic?path=${syzklbt[0].pic.picurl}" width="80" height="65"/></a></dt>
                    ...
                    <ul>
                        <c:forEach items="${syzklbt}" var="movie" varStatus="idx">
                            <li>
                                <a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><span>${movie.movename}</span>${movie.language}
                                </a></li>
                        </c:forEach>
                    </ul>
                </div>
        ...
        <div class="left_4 top10px" style="height:auto;">
            <h2><a href="#">爱情</a><span> ---- 畅享影业帮助您快速购票、享受便捷网络购票体验 </span></h2>
            <div class="inner">
                <c:forEach items="${aq}" var="movie">
                    <dl class="anli_list">
                        <dt><a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><img
                                src="<%=basePath%>/movie/getPic?path=${movie.pic.picurl}" width="150" height="100"/></a></dt>
                        <dd><a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}">${movie.movename}</a>
                            <p style="font-weight:bold;">${movie.date}</p>
                            <p>${movie.director}</p>
                            <p>导演：${movie.actor}</p>
                            <p><a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><input type="button" class="dgbg02"
                                                                                         value="特惠购票"/></a></p>
                        </dd>
                    </dl>
                </c:forEach>
                            ...
                            <td id="demo1" valign="top">
                                <table border="0" cellpadding="0">
                                    <tr>
                                        <td align="center">
                                            <dl class="anli_list">
                                                <dt><a href="#"><img src="<%=basePath%>/assets/movie/images/al1.jpg" width="150"
                                                                     height="100"/></a></dt>
                                                <dd><a href="#">十二生肖</a></dd>
                                            </dl>
                                        </td>
                                        <td align="center">
                                            <dl class="anli_list">
                                                <dt><a href="#"><img src="<%=basePath%>/assets/movie/images/al2.jpg" width="150"
                                                                     height="100"/></a></dt>
                                                <dd><a href="#">青春期3</a></dd>
                                            </dl>
                                        </td>
                                        <td align="center">
                                            <dl class="anli_list">
                                                <dt><a href="#"><img src="<%=basePath%>/assets/movie/images/al3.jpg" width="150"
                                                                     height="100"/></a></dt>
                                        ...
                                        <td align="center">
                                            <dl class="anli_list">
                                                <dt><a href="#"><img src="<%=basePath%>/assets/movie/images/al4.jpg" width="150"
                                                                     height="100"/></a></dt>
                ...
                <dl style="height: 60px">
                    ...
                    <dd style=" padding-top:10px;">
                        <input name="" type="button" class="dgbg" value="立即订购"
                               onclick="subOrderKs('<%=basePath%>/movie/videoInfo?movieid=','movieId')"/>
                    </dd>
                    <div class="clear"></div>
                </dl>
                <dl style="height: 60px">
            ...
            <div class="inner02">
                <ul class="server_list">
                    <c:forEach items="${syxklbt}" var="movie">
                        <li>
                            <a href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><span>${movie.language}</span>${movie.movename}
                            </a></li>
                    </c:forEach>
                </ul>
            </div>
            ...
            <div class="inner022">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <c:forEach items="${movieList}" var="movie">
                        <tr>
                            <td height="135" align="center" width="140"><a
                                    href="<%=basePath%>/movie/videoInfo?movieid=${movie.moveid}"><img
                                    src="<%=basePath%>/movie/getPicById?picId=${movie.picid}" width="120" height="100"/></a></td>
                            <td><a href="#">${movie.movename}</a>
                                <p>导演:${movie.actor}</p></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
