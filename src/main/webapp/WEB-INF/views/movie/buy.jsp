...
<html lang="en">
	...
	<div id="user-profile-3" class="user-profile row">
		<div class="col-sm-offset-1 col-sm-10">
			<div class="space"></div>
            <form class="form-horizontal" action="<%=basePath%>/movie/order" method="post" >
                <div class="col-sm-12">
                    <img src="<%=basePath%>/movie/getPic?path=${movie.pic.picurl}" width="200" height="300" class="col-sm-4" width="145" height="33" id="identity"/>
                                        ...
                                        <c:forEach items="${schedule.hallSetList}" var="setNum">
                                            ...
                                            <td>
                                                <c:if test="${!setNum.isSelect}">
                                                    <a href="#"class="btn btn-xs btn-success" onclick="optionMovie('<%=basePath%>/movie/subOrder?setNum=${setNum.num}','scheduleid','${schedule.scheduleid}')">${setNum.num}</a>
                                                </c:if>
                                                <c:if test="${setNum.isSelect}">
